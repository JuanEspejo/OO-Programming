...
class BasePlusCommissionEmployee
{
   ...
   {
      // call to CommissionEmployee constructor to instantiate instance variable
      commissionEmployee = new CommissionEmployee(firstName, lastName, dni, 
